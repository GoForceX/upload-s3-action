...
var signatureV4 = __webpack_require__(1528);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4601); });
    const sso = ssoClient ||
...
const core_1 = __webpack_require__(9963);
...
const core_2 = __webpack_require__(5829);
const smithy_client_1 = __webpack_require__(3570);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 334).then(__webpack_require__.t.bind(__webpack_require__, 7334, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 334).then(__webpack_require__.t.bind(__webpack_require__, 7334, 23));
